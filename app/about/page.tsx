export default function ToDo() {
  return (
    <main className="bg-gradient-to-r from-black to-red-700 text-white text-center p-4 h-full">
      <h1 className="border-2 rounded-xl w-32 ml-auto mr-auto mb-3">
        主爱聚会
      </h1>
      <div className="flex flex-col w-full max-w-lg gap-2 m-auto">
        ...
        />
        <TableRow a="北美西岸群周一聚会" b="美西  7: 50PM北京10:50 AM (周二)" />
      ...
      <div className="flex flex-col w-full max-w-lg gap-2 m-auto text-left">
